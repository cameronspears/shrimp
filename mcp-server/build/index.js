...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: 'shrimp_check',
            description: 'Run a comprehensive health check on a codebase. Analyzes bugs, performance issues, code consistency, imports, accessibility, and more. Returns a health score (0-100) and actionable recommendations.',
            inputSchema: {
                type: 'object',
                properties: {
                    path: {
        ...
        {
            name: 'shrimp_fix',
            description: 'Automatically fix safe code health issues. Can fix unused imports, accessibility issues, performance problems, and common bugs. Supports dry-run mode to preview changes before applying.',
            inputSchema: {
                type: 'object',
                properties: {
                    path: {
        ...
        {
            name: 'shrimp_status',
            description: 'Get quick status of codebase health including current score, recent trends, and top issues. Useful for monitoring health over time.',
            inputSchema: {
                type: 'object',
                properties: {
                    path: {
        ...
        {
            name: 'shrimp_explain',
            description: 'Get detailed explanation of a specific code health issue type, including why it matters, how to fix it, and examples.',
            inputSchema: {
                type: 'object',
                properties: {
                    issueType: {
        ...
        },
        {
            ...
            description: 'Start background file watching for real-time health monitoring. The watcher runs in the background and tracks health score changes as files are modified. This enables proactive health monitoring without explicit checks.',
            inputSchema: {
                type: 'object',
                properties: {
                    path: {
        ...
        },
        {
            ...
            description: 'Stop background file watching. Returns final statistics including total checks performed and final health score.',
            inputSchema: {
                type: 'object',
                properties: {},
            },
        },
        {
            ...
            description: 'Get real-time health status from the file watcher WITHOUT running a new check. This is much faster than shrimp_check as it returns cached results from the background watcher. Use this to monitor health changes in real-time.',
            inputSchema: {
                type: 'object',
                properties: {
                    includeIssues: {
